...
def main():
    ...
    parser.add_argument('--data_path', default = '/content/drive/MyDrive/semantic-segmentation-master/infer/data/', type = str, help = 'Folder to store the unannotated text files')
    parser.add_argument('--model_path', default = '/content/drive/MyDrive/semantic-segmentation-master/saved/model_state0.tar', type = str, help = 'Path to trained Hierarchical BiLSTM CRF Model')
    ...
    parser.add_argument('--save_path', default = '/content/drive/MyDrive/semantic-segmentation-master/infer/predictions.txt', type = str, help = 'Path to file where predictions will be saved')
    parser.add_argument('--word2idx_path', default = '/content/drive/MyDrive/semantic-segmentation-master/saved/word2idx.json', type = str, help = 'Path to word2idx dict created during training model')
    parser.add_argument('--tag2idx_path', default = '/content/drive/MyDrive/semantic-segmentation-master/saved/tag2idx.json', type = str, help = 'Path to tag2idx dict created during training model')
