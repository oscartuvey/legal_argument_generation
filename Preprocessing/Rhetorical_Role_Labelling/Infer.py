...
def main():
    ...
    parser.add_argument('--data_path', default = 'Preprocessing/Rhetorical_Role_Labelling/infer/data/', type = str, help = 'Folder to store the unannotated text files')
    parser.add_argument('--model_path', default = 'Preprocessing/Rhetorical_Role_Labelling/saved/model_state0.tar', type = str, help = 'Path to trained Hierarchical BiLSTM CRF Model')
    ...
    parser.add_argument('--save_path', default = 'Preprocessing/Rhetorical_Role_Labelling/infer/predictions.txt', type = str, help = 'Path to file where predictions will be saved')
    parser.add_argument('--word2idx_path', default = 'Preprocessing/Rhetorical_Role_Labelling/saved/word2idx.json', type = str, help = 'Path to word2idx dict created during training model')
    parser.add_argument('--tag2idx_path', default = 'Preprocessing/Rhetorical_Role_Labelling/saved/tag2idx.json', type = str, help = 'Path to tag2idx dict created during training model')
